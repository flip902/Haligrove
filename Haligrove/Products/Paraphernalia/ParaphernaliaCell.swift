...
class ParaphernaliaCell: FoldingCell, NSCacheDelegate {
    
    // MARK: - Property Declarations
    var product: Product?
    weak var delegate: ParaphernaliaFavoriteDelegate?
    ...
    func setupFoldingCell(product: Product) {
        ...
        productNameLabel.textColor = #colorLiteral(red: 0.4594036341, green: 0.2991636693, blue: 0.5661311746, alpha: 1)
    ...
    @objc func favoritedStrain() {
        delegate?.didTapParaphernaliaFavoritesButton(in: self)
    }
